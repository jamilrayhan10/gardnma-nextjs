...
const ArborManagementArea = ({arbor, nursery, trimming, weeds, fruit} : any) => {
                    ...
                    <div className="col-xl-8">
                        <div className="services-details__content">
                            <div className="services-details__content-img1">
                                {arbor && <img src="assets/images/services/services-details-img1.jpg" alt="#" />}
                                {nursery && <img src="assets/images/services/services-details-img7.jpg" alt="#" />}
                                {trimming && <img src="assets/images/services/services-details-img8.jpg" alt="#" />}
                                {weeds && <img src="assets/images/services/services-details-img9.jpg" alt="#" />}
                                {fruit && <img src="assets/images/services/services-details-img5.jpg" alt="#" />}
                            </div>

                            <div className="text-box1">
                              {arbor && <h2>Arbor Management</h2>} 
                                {nursery && <h2>Nursery/Tree Farm </h2>}
                                {trimming && <h2>Trimming & Pruning </h2>}
                                {weeds && <h2>Pests & Weeds Control </h2>}
                                {fruit && <h2>Fruits & Flowers Garden </h2>}
...
export default ArborManagementArea;